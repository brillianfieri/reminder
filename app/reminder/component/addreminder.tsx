         ...
         <Modal isOpen={isOpen} onRequestClose={() => setIsOpen(false)} style={customStyles}>
            ...
            <form onSubmit={handleSubmit} className="p-5 rounded-xl bg-white dark:bg-zinc-900" >
                ...
                {selectDate ? 
                    <div className='flex items-center justify-center mb-6'>
                        <div className="relative z-0 w-full  group">
                            <input type="date" name="date" id="date" defaultValue={new Date().toISOString().split('T')[0]}  className="block py-3 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "  />
                ...
                {selectTime ? 
                    <div className='flex items-center justify-center mb-6'>
                        <div className="relative z-0 w-full group">
                            <input type="time"  defaultValue={"00:00"} name="time" id="time"  className="block py-3 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "  />
